# Sei Network Token Creation Tool

A simple frontend tool to create tokens on the Sei Network (SEI) network using a backend API.
...
- Insert this project link https://github.com/BayHatter/Sei-Network-Token-Creation-Tool-Without-Coding-and-With-Monetization.git
- And press deploy
- Congrats your Sei Network Token Creation Tool installed on your vercel.com account
...
- Then donwload our code from https://github.com/BayHatter/Sei-Network-Token-Creation-Tool-Without-Coding-and-With-Monetization
- Upload into your Github repo.
- Edit the file public/config.json and insert your Sei Network wallet address for receiving fees. Also set fee in SEI that you want to charge
